...
class __TwigTemplate_64706656d75764610ff2cf9e9ccda9e9 extends Template
{
    ...
    ";
        ...
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 9, $this->source); })()), "email", [], "any", false, false, false, 9), 'row', ["label" => "Email "]);
        // line 11
        echo "
        ";
        // line 12
...
{% endblock %}
", "registration/register.html.twig", "/var/www/sae301/templates/registration/register.html.twig");
    }
}
